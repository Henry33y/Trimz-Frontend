        ...
        <div className="max-w-2xl mx-auto p-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-6 mb-6">
                <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                        <h3 className="font-bold text-slate-900 text-lg">{providerData?.name}</h3>
                        <p className="text-sm text-slate-600">{providerData?.specialization || 'Professional Stylist'}</p>
                        {providerData?.location && (
                            <p className="text-xs text-slate-500 mt-1">📍 {providerData.location}</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 p-4 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl transition-all border-2 border-slate-200 active:scale-95"
                >
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
                <h4 className="font-bold text-slate-900 mb-3 text-sm">Why Connect?</h4>
